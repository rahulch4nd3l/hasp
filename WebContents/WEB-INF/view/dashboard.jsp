        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="dashboard"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-dashboard" style="margin-right: 5px;">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="contact-clean">
                        <form method="post" name = "form" action = "bookservice" onsubmit= "return validate()">
                            <h2 class="text-center">Enter Details</h2>
                            <div class="mb-3"><input class="form-control" type="text" name="city" placeholder="Enter City" required></div>
                            <div class="mb-3"><select class="form-select" name="serviceType" value="" required>
                            ...
                            <div class="mb-3"><input class="form-control" type="date" pattern = "MM-dd-yy" name="date" onchange= ""></div>
                            <div class="mb-3"><button class="btn btn-primary" type="submit">Submit Request</button></div>
                        </form>
                    </section>
                </div>
            </div>
