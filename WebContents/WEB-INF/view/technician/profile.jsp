...
<head>
    ...
    <title>Profile - Technician</title>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action = "saveBasic">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>First Name</strong></label><input class="form-control" type="text" id="first_name" placeholder="Enter First Name" name="first_name" value="${tech.firstName}"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="last_name"><strong>Last Name</strong></label><input class="form-control" type="text" id="last_name" placeholder="Enter Last Name" name="last_name" value="${tech.lastName}"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Email Address</strong></label><input class="form-control" type="email" id="email" placeholder="Enter Email" name="email" value="${tech.email}"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Phone Number</strong></label><input class="form-control" type="text" id="username" placeholder="Enter Phone" name="phone" value="${tech.phone}"></div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action = "saveLocation">
                                                <div class="mb-3"><label class="form-label" for="address"><strong>Service Type</strong></label><select class="form-select" name="serviceType" value="${tech.service}">
                                                        <option value="undefined" selected="${tech.service}">Select Service Type</option>
                                                        <option value="fan">Fan</option>
                                                        <option value="ac">AC</option>
                                                        <option value="tv">TV</option>
                                                        <option value="electrical">Electrical Wiring</option>
                                                        <option value="washineMachine">Washing Machine</option>
                                                    </select></div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="city"><strong>City</strong></label><input class="form-control" type="text" id="city" placeholder="Enter City" name="city" value="${tech.city}"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="country"><strong>Country</strong></label><input class="form-control" type="text" id="country" placeholder="Enter Country" name="country" value="${tech.country}"></div>
                                                    </div>
                                                </div>
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit">Save&nbsp;Settings</button></div>
                                            </form>
