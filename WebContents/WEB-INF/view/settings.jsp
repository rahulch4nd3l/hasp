...
<script type="text/javascript">
	...
	function validate() {
		var old = document.form.oldpass.value;
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="contact-clean">
                        <form method="post" name = "form" onsubmit= "return validate()" action = "changePass">
                            <h2 class="text-center">Change Password</h2>
                            <div class="mb-3"><input class="form-control" type="password" name="oldpass" placeholder="Enter Current Password" required="" minlength="1"></div>
                            <div class="mb-3"><input class="form-control" type="password" name="newPass" placeholder="Enter New Password" required="" minlength="6"></div>
                            <div class="mb-3"><input class="form-control" type="password" name="repeatnewPass" placeholder="Repeat New Password" required="" minlength="6"></div>
